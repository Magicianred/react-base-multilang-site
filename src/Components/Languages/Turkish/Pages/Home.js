...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/turkish/home_messages.json`)
                .then((result) => {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/turkish/pages/home.md`)
                .then((result) => {
                    mdText = result.data;
        ...
        return (
            <Layout>
                ...
                <Jumbotron>
                    <Container>
                        {firstItem ?
                            ...
                            : 
                            <>
                                <h1 className="display-4">Ana Sayfa</h1>
                                <p className="lead">Bu ana sayfadır</p>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/turkish/pages/home.md</span>
                    <SyntaxHighlighter language={'markdown'} style={coy}>
                        {mdText}
                    </SyntaxHighlighter>
                </Container>
                <Container className="file_contents">
                    <span>file: /data/languages/turkish/home_messages.json</span>
