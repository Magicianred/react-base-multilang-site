...
class About extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/turkish/pages/about.md`)
                .then((result) => {
                    mdText = result.data;
    ...
    render() {
        ...
        return (
            <Layout>
                ...
                <Jumbotron>
                    <Container>
                        <h1 className="display-4">Hakkında sayfası</h1>
                        <p className="lead">Bu yaklaşık sayfası</p>
                    </Container>
                </Jumbotron>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/turkish/pages/about.md</span>
