            ...
            <Navbar bg="dark" variant="dark" expand="md" role="navigation">
                ...
                <Navbar.Collapse id="site-navbar-nav">
                    <Nav className="mr-auto">
                        <Nav.Link id="home_link" href={`${publicUrl}/#/tr/`}>Ev</Nav.Link>
                        <Nav.Link id="about_link" href={`${publicUrl}/#/tr/hakkında`}>Benim hakkımda</Nav.Link>
                        <Nav.Link id="classes_link" href={`${publicUrl}/#/tr/sınıflar`}>Sınıflar</Nav.Link>
                    </Nav>
                    <LanguagesSwitch />
