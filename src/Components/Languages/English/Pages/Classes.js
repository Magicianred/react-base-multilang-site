...
class Classes extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/english/pages/classes.md`)
                .then((result) => {
                    mdText = result.data;
        ...
        return (
            <Layout>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/english/pages/classes.md</span>
                    <SyntaxHighlighter language={'markdown'} style={coy}>
                        {mdText}
                    </SyntaxHighlighter>
                </Container>
                <Container className="file_contents">
                    <span>file: /data/languages/english/classes.json</span>
