...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/english/pages/home.md`)
                .then((result) => {
                    mdText = result.data;
        ...
        return (
            <Layout>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/english/pages/home.md</span>
                    <SyntaxHighlighter language={'markdown'} style={coy}>
                        {mdText}
                    </SyntaxHighlighter>
                </Container>
                <Container className="file_contents">
                    <span>file: /data/languages/english/home_messages.json</span>
