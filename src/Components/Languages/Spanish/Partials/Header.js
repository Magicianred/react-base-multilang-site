            ...
            <Navbar bg="dark" variant="dark" expand="md" role="navigation">
                ...
                <Navbar.Collapse id="site-navbar-nav">
                    <Nav className="mr-auto">
                        <Nav.Link id="home_link" href={`${publicUrl}/#/es/`}>Home</Nav.Link>
                        <Nav.Link id="about_link" href={`${publicUrl}/#/es/sobremi`}>Sobre mí</Nav.Link>
                        <Nav.Link id="classes_link" href={`${publicUrl}/#/es/clases`}>Clases</Nav.Link>
                    </Nav>
                    <LanguagesSwitch />
