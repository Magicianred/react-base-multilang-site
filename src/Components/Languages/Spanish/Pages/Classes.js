...
class Classes extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/spanish/classes.json`)
                .then((result) => {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/spanish/pages/classes.md`)
                .then((result) => {
                    mdText = result.data;
    ...
    render() {
        ...
        return (
            <Layout>
                ...
                <Jumbotron>
                    <Container>
                        <h1 className="display-4">Classes Page</h1>
                        <p className="lead">This is the classes page</p>
                    </Container>
                </Jumbotron>
                <Container>
                    <Row>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/spanish/pages/classes.md</span>
                    <SyntaxHighlighter language={'markdown'} style={coy}>
                        {mdText}
                    </SyntaxHighlighter>
                </Container>
                <Container className="file_contents">
                    <span>file: /data/languages/spanish/classes.json</span>
