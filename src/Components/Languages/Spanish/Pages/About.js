...
class About extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/spanish/pages/about.md`)
                .then((result) => {
                    mdText = result.data;
    ...
    render() {
        ...
        return (
            <Layout>
                ...
                <Jumbotron>
                    <Container>
                        <h1 className="display-4">Acerca de la página</h1>
                        <p className="lead">Esta es la página acerca de</p>
                    </Container>
                </Jumbotron>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/spanish/pages/about.md</span>
