...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/spanish/home_messages.json`)
                .then((result) => {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/spanish/pages/home.md`)
                .then((result) => {
                    mdText = result.data;
        ...
        return (
            <Layout>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/spanish/pages/home.md</span>
                    <SyntaxHighlighter language={'markdown'} style={coy}>
                        {mdText}
                    </SyntaxHighlighter>
                </Container>
                <Container className="file_contents">
                    <span>file: /data/languages/spanish/home_messages.json</span>
