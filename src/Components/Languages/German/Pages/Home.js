...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/german/home_messages.json`)
                .then((result) => {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/german/pages/home.md`)
                .then((result) => {
                    mdText = result.data;
        ...
        return (
            <Layout>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/german/pages/home.md</span>
                    <SyntaxHighlighter language={'markdown'} style={coy}>
                        {mdText}
                    </SyntaxHighlighter>
                </Container>
                <Container className="file_contents">
                    <span>file: /data/languages/german/home_messages.json</span>
