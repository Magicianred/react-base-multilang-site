...
class Classes extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/german/classes.json`)
                .then((result) => {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/german/pages/classes.md`)
                .then((result) => {
                    mdText = result.data;
    ...
    render() {
        ...
        return (
            <Layout>
                ...
                <Jumbotron>
                    <Container>
                        <h1 className="display-4">Klassen Seite</h1>
                        <p className="lead">Dies ist die Klassenseite</p>
                    </Container>
                </Jumbotron>
                <Container>
                    <Row>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/german/pages/classes.md</span>
                    <SyntaxHighlighter language={'markdown'} style={coy}>
                        {mdText}
                    </SyntaxHighlighter>
                </Container>
                <Container className="file_contents">
                    <span>file: /data/languages/german/classes.json</span>
