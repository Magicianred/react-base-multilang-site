...
class About extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/german/pages/about.md`)
                .then((result) => {
                    mdText = result.data;
    ...
    render() {
        ...
        return (
            <Layout>
                ...
                <Jumbotron>
                    <Container>
                        <h1 className="display-4">Über Seite</h1>
                        <p className="lead">Dies ist die About-Seite</p>
                    </Container>
                </Jumbotron>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/german/pages/about.md</span>
