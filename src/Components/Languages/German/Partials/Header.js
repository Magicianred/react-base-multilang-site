            ...
            <Navbar bg="dark" variant="dark" expand="md" role="navigation">
                ...
                <Navbar.Collapse id="site-navbar-nav">
                    <Nav className="mr-auto">
                        <Nav.Link id="home_link" href={`${publicUrl}/#/de/`}>Home</Nav.Link>
                        <Nav.Link id="about_link" href={`${publicUrl}/#/de/ubermich`}>Über mich</Nav.Link>
                        <Nav.Link id="classes_link" href={`${publicUrl}/#/de/klassen`}>Klassen</Nav.Link>
                    </Nav>
                    <LanguagesSwitch />
