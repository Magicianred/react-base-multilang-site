            ...
            <Navbar bg="dark" variant="dark" expand="md" role="navigation">
                ...
                <Navbar.Collapse id="site-navbar-nav">
                    <Nav className="mr-auto">
                        <Nav.Link id="home_link" href={`${publicUrl}/#/it/`}>Principale</Nav.Link>
                        <Nav.Link id="about_link" href={`${publicUrl}/#/it/chisono`}>Su di me</Nav.Link>
                        <Nav.Link id="classes_link" href={`${publicUrl}/#/it/classi`}>Classi</Nav.Link>
                    </Nav>
                    <LanguagesSwitch />
