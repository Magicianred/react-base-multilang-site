...
class About extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/italian/pages/about.md`)
                .then((result) => {
                    mdText = result.data;
    ...
    render() {
        ...
        return (
            <Layout>
                ...
                <Jumbotron>
                    <Container>
                        <h1 className="display-4">Pagina Chi Siamo</h1>
                        <p className="lead">Questa è la pagina chi siamo</p>
                    </Container>
                </Jumbotron>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/italian/pages/about.md</span>
