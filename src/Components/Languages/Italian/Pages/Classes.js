...
class Classes extends Component {
    ...
    componentDidMount() {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/italian/classes.json`)
                .then((result) => {
        ...
        this.serverRequest = 
            axios
                .get(`${publicUrl}/data/languages/italian/pages/classes.md`)
                .then((result) => {
                    mdText = result.data;
    ...
    render() {
        ...
        return (
            <Layout>
                ...
                <Jumbotron>
                    <Container>
                        <h1 className="display-4">Pagina Classi</h1>
                        <p className="lead">Questa è la pagina classi</p>
                    </Container>
                </Jumbotron>
                <Container>
                    <Row>
                ...
                <Container className="file_contents">
                    <span>file: /data/languages/italian/pages/classes.md</span>
                    <SyntaxHighlighter language={'markdown'} style={coy}>
                        {mdText}
                    </SyntaxHighlighter>
                </Container>
                <Container className="file_contents">
                    <span>file: /data/languages/italian/classes.json</span>
